...
export class MediaService {
     ...
     * not an empty list (indistinguishable otherwise). Reuses `getInstanceForWrite`'s minimal
     * select, the same existence check `TaskInstanceService.loadForWrite` already uses.
     */
